<template>
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 lg:gap-8 items-center">
    <UPageHero
      :ui="{
    ...
    >
      ...
      <template #title>
        ...
        <span class="text-blue-400" aria-live="polite" aria-atomic="true">{{ currentWordDisplay }}</span>
      ...
      <template #description>
        Whether you need to create a brand identity, website, mobile app, marketing campaign, the key to making the project a success starts with having a well-thought-out creative brief.
      </template>
    ...
    <!-- Image centrée  pour mobile et desktop -->
    <div class="flex justify-center mt-0 lg:mt-0">
